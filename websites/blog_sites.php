<?php $title = "blog Sites" ?>
<?php $description = "Hurry Up Print blog websites, build blog site, custom blog site" ?>
...
<nav class="yellow darken-1 m2a">
  <div class="nav-wrapper ms2">
    <div class="col s12">
      ...
      <a href="/websites/blog_sites.php" class="breadcrumb black-text">Blog Sites</a>
    </div>
  </div>
</nav>

<section class="blog_sites__section">
<h1>Blog Sites</h1>
